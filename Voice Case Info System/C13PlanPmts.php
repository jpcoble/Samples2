<?php
	...
	$tsql = "IF (SELECT FilingDate FROM Cases WHERE CaseNumber = $CaseNumber) <> '1900-01-01 00:00:00.000' (SELECT FORMAT(PlanPmt, 'C', 'en-us'), PmtPeriod FROM Cases WHERE CaseNumber=$CaseNumber)";
	/
	...
	{    
			...
			echo '<Say voice="alice" language="en-GB">Your Chapter 13 Plan payments are, '.$result[0].', '.$result[1].'. 
