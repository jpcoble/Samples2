<?php
	...
	{
		echo '<Gather action="ExpectedDischargeDate.php" numDigits="7">'; //note just using clientid here, so one digit
		echo '<Say voice="alice" language="en-GB">Please enter your 7 digit case number</Say>';
		echo '</Gather>';
	}
	...
	{
		echo '<Gather action="DebtorEd.php" numDigits="7">'; //note just using clientid here, so one digit
		echo '<Say voice="alice" language="en-GB">Please enter your 7 digit case number</Say>';
		echo '</Gather>';
	}
